    ...
    return (
        <div className='flex flex-wrap gap-4 px-4 py-8 justify-center'>
            {CardData.slice(3,5).map((item, i) => (
                <div 
                    key={i} 
                    className='w-full sm:w-[350px] md:w-[500px] h-[220px] rounded-xl p-4 bg-cover bg-center relative flex items-center shadow-md'
                    style={{ backgroundImage: `url(${item.image})` }} 
                >
                    <div className='p-4  bg-opacity-80 rounded-lg text-black w-[80%] sm:w-[70%] md:w-[60%]'>
